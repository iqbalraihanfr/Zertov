...
const BASE_CLOUD_WIDTH = 400

const CLOUD_IMAGE = "/team/77.png"
...
function TeamMemberCard({ member, variant }: { member: TeamMember; variant: "stacked" | "floating" }) {
  ...
  const cloudOffset = cloudWidth * 1
    ...
    >
      <div className="relative flex w-full flex-col items-center">
        ...
        <Image
          ...
          height={400}
          aria-hidden="true"
          className={`pointer-events-none top-20 absolute left-1/2 z-20 -translate-x-1/2 transition duration-500 group-hover:scale-[1.05] ${member.desktop.cloudClass ?? ""}`}
